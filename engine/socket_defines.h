...
enum SocketIOEvent
{
	...
	SOCKET_IO_EVENT_CONNECT_COMPLETE	= 1,
	SOCKET_IO_EVENT_READ_COMPLETE		= 2,
	SOCKET_IO_EVENT_WRITE_COMPLETE		= 3,
	SOCKET_IO_EVENT_CLOSE				= 4,
	SOCKET_IO_EVENT_DELAY_SEND			= 5,
	SOCKET_IO_THREAD_SHUTDOWN			= 6,
	SOCKET_IO_THREAD_WAKEUP				= 7,
